...
void GLRenderer::DrawScene(CDC* pDC)
{
	...
	mat_amb[0] = 0; mat_amb[1] = 0.7; mat_amb[2] = 0.7;
	mat_dif[0] = 0.8; mat_dif[1] = 0.5; mat_dif[2] = 1;
	mat_spec[0] = mat_spec[1] = mat_spec[2] = 0.2;
	mat_shin = 112.0;
	GLMaterial lightVasePartMaterial(mat_amb, mat_dif, mat_spec, mat_emm, mat_shin);

	mat_amb[0] =0; mat_amb[1] = 0; mat_amb[2] = 0.7;
	mat_dif[0] = 0.8; mat_dif[1] = 0; mat_dif[2] = 1;
	mat_spec[0] = mat_spec[1] = mat_spec[2] = 0.2;
	mat_shin = 112.0;
	...
	if (redOn)
	{
		...
		GLfloat light1_ambient[] = { 0.8, 0.0, 0.0, 1.0 };
